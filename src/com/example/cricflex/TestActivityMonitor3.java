...
public class TestActivityMonitor3 extends Activity implements BluetoothAdapter.LeScanCallback {
...
//            System.out.println("Re-Converting to arraylist : " + list);
            ...
            Intent i = new Intent(TestActivityMonitor3.this, ActivityMain.class);
            TestActivityMonitor3.this.startActivity(i);
...
//            TestActivityMonitor.this.startActivity(i);
    ...
    class handleGraphButton implements OnClickListener {
        public void onClick(View v) {
            Intent intent = new Intent(TestActivityMonitor3.this, ActivityGraph5.class);
...
//        connectionStatusText = (TextView) findViewById(R.id.test);
        ...
        username = SaveSharedPreference.getUserName(TestActivityMonitor3.this);
...
//                    }
    ...
    */
        ...
        TestActivityMonitor3.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
        ...
        if (!(bluetoothDevice.getName().equals("Abdullah"))) {
            bluetoothAdapter.startLeScan(new UUID[]{RFDService.UUID_SERVICE}, TestActivityMonitor3.this);
        } else {
            Intent rfduinoIntent = new Intent(TestActivityMonitor3.this, RFDService.class);
