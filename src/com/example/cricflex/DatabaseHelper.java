...
public class DatabaseHelper extends SQLiteOpenHelper{
    ...
    private static final String COLUMN_SECURITYQUES = "securityques";

    SQLiteDatabase db;


    private static final String TABLE_CREATE = "create table "+TABLE_NAME+" (id integer primary key not null  , "+
            " email text not null , username text not null, password text not null, securityques text not null);";
    ...
    public void insertPlayer(Player p){
        ...
        values.put(COLUMN_SECURITYQUES, p.getSecurityques());
