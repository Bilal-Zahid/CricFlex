...
public class CricFlex_Bluetooth {
	public static String shortUuidFormat = "0000%04X-0000-1000-8000-00805F9B34FB";      // for RFduino
        ...
        while (i < scanRecord.length) {
            ...
            switch (scanRecord[i] & 0xFF) {
                ...
                case 0xFF: // Manufacturer Specific data (RFduinoBLE.advertisementData)
                    output.append("\n  Advertisement Data: ")
                            .append(DataTypeConversion.bytesToHex(scanRecord, i + 3, len));

                    String ascii = DataTypeConversion.bytesToAsciiMaybe(scanRecord, i + 3, len);
                    if (ascii != null) {
