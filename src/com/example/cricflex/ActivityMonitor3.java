...
public class ActivityMonitor3 extends Activity implements BluetoothAdapter.LeScanCallback {
...
//            System.out.println("Re-Converting to arraylist : " + list);
            ...
            Intent i = new Intent(ActivityMonitor3.this, ActivityMain.class);
            ActivityMonitor3.this.startActivity(i);
...
//            ActivityMonitor.this.startActivity(i);
    ...
    class handleGraphButton implements OnClickListener {
        public void onClick(View v) {
            Intent intent = new Intent(ActivityMonitor3.this, ActivityGraph5.class);
...
//        connectionStatusText = (TextView) findViewById(R.id.test);
        ...
        username = SaveSharedPreference.getUserName(ActivityMonitor3.this);
...
//                    }
    ...
    */
        ...
        ActivityMonitor3.this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
        ...
        if (!(bluetoothDevice.getName().equals("Abdullah"))) {
            bluetoothAdapter.startLeScan(new UUID[]{RFDService.UUID_SERVICE}, ActivityMonitor3.this);
        } else {
            Intent rfduinoIntent = new Intent(ActivityMonitor3.this, RFDService.class);
