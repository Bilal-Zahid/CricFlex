...
public class TestActivitySessionStats extends Activity {
...
//        ll.setTextSize(12f);
    ...
    class handleEndSessionButton implements View.OnClickListener {
        public void onClick(View v) {
            ...
            Intent i = new Intent(TestActivitySessionStats.this, ActivityMain.class);
            TestActivitySessionStats.this.startActivity(i);
