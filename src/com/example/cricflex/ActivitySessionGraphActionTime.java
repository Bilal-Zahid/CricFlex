...
public class ActivitySessionGraphActionTime extends AppCompatActivity {
...
//    ArrayList<Float> values = new ArrayList<Float>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawLineChartForActionTime(lineChartValues,actionTimeValues,parameterName);
...
//        System.out.println(parameterName + " " + values);
    ...
    class handleEndSessionButton implements View.OnClickListener {
        public void onClick(View v) {
            ...
            Intent i = new Intent(ActivitySessionGraphActionTime.this, ActivityMain.class);
            ActivitySessionGraphActionTime.this.startActivity(i);
